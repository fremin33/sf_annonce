 ...
 * @ORM\Entity(repositoryClass="ff\PlatformBundle\Repository\AdvertRepository")
 */
class Advert
{
     ...
     * Set image
     *
     * @param \ff\PlatformBundle\Entity\Image $image
     *
     * @return Advert
     */
    public function setImage(\ff\PlatformBundle\Entity\Image $image = null)
    {
        $this->image = $image;
     ...
     * Get image
     *
     * @return \ff\PlatformBundle\Entity\Image
     */
     ...
     * Add category
     *
     * @param \ff\PlatformBundle\Entity\Category $category
     *
     * @return Advert
     */
    public function addCategory(\ff\PlatformBundle\Entity\Category $category)
    {
     ...
     * @param \ff\PlatformBundle\Entity\Category $category
     */
    public function removeCategory(\ff\PlatformBundle\Entity\Category $category)
    {
