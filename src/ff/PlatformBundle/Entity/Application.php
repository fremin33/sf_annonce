 ...
 * @ORM\Entity(repositoryClass="ff\PlatformBundle\Repository\ApplicationRepository")
 */
class Application
{
    /**
     ...
     * @return Application
     */
    public function addAdvert(\ff\PlatformBundle\Entity\Advert $advert)
    {
        $this->advert[] = $advert;
     ...
     * @param \ff\PlatformBundle\Entity\Advert $advert
     */
    public function removeAdvert(\ff\PlatformBundle\Entity\Advert $advert)
    {
